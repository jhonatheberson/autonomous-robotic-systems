...
disp('Program started');
    ...
    teta_f = 0;
     ...
     [X, Y, a, b, Mat] = poli_cubic(point_init,point_end, teta_i, teta_f, 0.01);
     ...
     while true %tempo de movimentação
         ...
         vrep.simxSetJointTargetVelocity(clientID,left_Motor,we,sim.simx_opmode_blocking);
         vrep.simxSetJointTargetVelocity(clientID,right_Motor,wd,sim.simx_opmode_blocking);
